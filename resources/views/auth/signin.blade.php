                    ...
                    <div class="card-body p-5">
                        <div class="text-center">
                            ...
                            <h4 class="fw-bold text-dark mb-2">¡Bienvenido de nuevo!</h3>
                                <p class="text-muted">Inicie sesión en su cuenta para continuar</p>
                        </div>
                        <form method="POST" action="{{ route('login') }}" class="mt-4">
                            ...
                            <div class="mb-3">
                                <div class="d-flex justify-content-between align-items-center">
                                    ...
                                    <a href="{{ route ('second' , ['auth','password']) }}" class="text-decoration-none small text-muted">¿Olvidó su contraseña?</a>
                                </div>
                            ...
                            <div class="d-grid">
                                <button class="btn btn-dark btn-lg fw-medium" type="submit">Iniciar sesión
</button>
                            </div>
                        </form>
                    </div>
                </div>
          <?php //      <p class="text-center mt-4 text-white text-opacity-50">Don't have an account?
